...
export default function NewColumnTab() {
  ...
  return (
    <div
      ...
      className="bg-new-column-bg group hover:bg-new-column-bg/70 flex h-full w-70 cursor-pointer items-center justify-center rounded-[6px] px-4 transition-all"
    >
